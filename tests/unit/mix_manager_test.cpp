...
TEST_F(MixManagerTest, GetRandomGenreDifferentFromCurrent) {
    ...
    Mix mix1, mix2, mix3;
    mix1.id = "test1"; mix1.title = "Test Mix 1"; mix1.artist = "Artist 1"; 
    mix1.genre = "Techno"; mix1.url = "http://example.com/1"; 
    mix1.local_path = ""; mix1.duration_seconds = 180;
    
    mix2.id = "test2"; mix2.title = "Test Mix 2"; mix2.artist = "Artist 2"; 
    mix2.genre = "House"; mix2.url = "http://example.com/2"; 
    mix2.local_path = ""; mix2.duration_seconds = 240;
    
    mix3.id = "test3"; mix3.title = "Test Mix 3"; mix3.artist = "Artist 3"; 
    mix3.genre = "Drum & Bass"; mix3.url = "http://example.com/3"; 
    mix3.local_path = ""; mix3.duration_seconds = 300;
...
TEST_F(MixManagerTest, GetRandomGenreDifferentFromCurrent_SingleGenre) {
    ...
    mix2.id = "test2"; mix2.title = "Test Mix 2"; mix2.artist = "Artist 2"; 
    mix2.genre = "Techno"; mix2.url = "http://example.com/2"; 
    mix2.local_path = ""; mix2.duration_seconds = 240;
...
TEST_F(MixManagerTest, AllRandomMixMethodsExcludeCurrentMix) {
    ...
    mix3.id = "test3"; mix3.title = "Test Mix 3"; mix3.artist = "Artist 1"; 
    mix3.genre = "Techno"; mix3.url = "http://example.com/3"; 
    mix3.local_path = ""; mix3.duration_seconds = 300;
    
    mix4.id = "test4"; mix4.title = "Test Mix 4"; mix4.artist = "Artist 3"; 
    mix4.genre = "Drum & Bass"; mix4.url = "http://example.com/4"; 
    mix4.local_path = ""; mix4.duration_seconds = 360;
...
TEST_F(MixManagerTest, RapidMixSelectionPreventsRepetition) {
    ...
    mix4.id = "test4"; mix4.title = "Test Mix 4"; mix4.artist = "Artist 4"; 
    mix4.genre = "Techno"; mix4.url = "http://example.com/4"; 
    mix4.local_path = ""; mix4.duration_seconds = 360;
    
    mix5.id = "test5"; mix5.title = "Test Mix 5"; mix5.artist = "Artist 5"; 
    mix5.genre = "Techno"; mix5.url = "http://example.com/5"; 
    mix5.local_path = ""; mix5.duration_seconds = 420;
