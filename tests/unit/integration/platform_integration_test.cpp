...
struct MockPlatformConfig {
    ...
    std::map<std::string, std::string> mock_env_vars = {{"HOME", "/home/testuser"},
    ...
    std::vector<std::string> mock_audio_devices = {"default", "pulse", "alsa", "speakers", "headphones"};
...
protected:
    ...
    void setupWindowsEnvironment() {
        ...
        MockPlatform::config.mock_env_vars = {{"USERPROFILE", "C:\\Users\\testuser"},
        ...
        MockPlatform::config.mock_audio_devices = {"default", "DirectSound", "WASAPI", "speakers", "headphones"};
    ...
    void setupMacOSEnvironment() {
        ...
        MockPlatform::config.mock_env_vars = {{"HOME", "/Users/testuser"}};
        ...
        MockPlatform::config.mock_audio_devices = {"default", "CoreAudio", "Built-in Output", "AirPods", "speakers"};
    ...
    void setupLinuxEnvironment() {
        ...
        MockPlatform::config.mock_env_vars = {{"HOME", "/home/testuser"},
                                              {"XDG_CONFIG_HOME", "/home/testuser/.config"},
                                              {"XDG_DATA_HOME", "/home/testuser/.local/share"},
                                              {"XDG_CACHE_HOME", "/home/testuser/.cache"}};
        ...
        MockPlatform::config.mock_audio_devices = {"default", "pulse", "alsa", "speakers", "headphones"};
...
TEST_F(PlatformIntegrationTest, CrossPlatformPathCompatibilityWorkflow) {
    ...
    EXPECT_TRUE(std::all_of(compatibility_results.begin(), compatibility_results.end(), [](bool b) { return b; }));
}
...
TEST_F(PlatformIntegrationTest, ConfigurationCompatibilityWorkflow) {
    ...
    for (const auto& platform : platforms) {
        ...
        bool compatible =
            MockPlatform::state.environment_variables_available && MockPlatform::state.path_system_initialized;
