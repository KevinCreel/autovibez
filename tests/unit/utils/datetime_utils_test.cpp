...
TEST(DateTimeUtilsTest, IsValidDateTime) {
    ...
    EXPECT_TRUE(AutoVibez::Utils::DateTimeUtils::isValidDateTime("2024-13-01 14:30:25")); // Invalid month but correct format
    EXPECT_TRUE(AutoVibez::Utils::DateTimeUtils::isValidDateTime("2024-01-32 14:30:25")); // Invalid day but correct format
    EXPECT_TRUE(AutoVibez::Utils::DateTimeUtils::isValidDateTime("2024-01-15 25:30:25")); // Invalid hour but correct format
}
